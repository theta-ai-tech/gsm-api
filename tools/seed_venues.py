...
``area`` stores the **metro region string** (``athens`` here) per the
venue-seeding convention — matching the *values* in ``config/regions.mapping``,
not neighbourhood names. See ``docs/data/data-dictionary.md`` → Collection:
venues.
"""
