...
`-50` penalty (3100 → 3050, above the Advanced 3000 floor, so no clamp). See `wiki/scoring.md` for the
...
`wiki/scoring.md` for the full per-player model and worked example.
