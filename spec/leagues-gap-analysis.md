...
|----------|------|--------|
| `leagues/{leagueId}` collection | `wiki/DATA_DICTIONARY.md` lines 397-410, 466-479 | Fully defined: name, sport, season, status, ownerUid, meta |
| `leagues/{leagueId}/members/{uid}` subcollection | `wiki/DATA_DICTIONARY.md` lines 412-525 | Fully defined: role, status, joinedAt, stats |
...
| User league caches | `wiki/DATA_DICTIONARY.md` lines 100-101 | `leaguesActive[]` and `leaguesCompleted[]` on user docs (cap 20) |
| Composite indexes | `wiki/DATA_DICTIONARY.md` lines 437-438 | League match indexes declared: `leagueId + status + scheduledAt/finishedAt` |
