...
Tiers are point bands sourced from `config/tiers` (see
[`../data/data-dictionary.md`](../data/data-dictionary.md)). A player's tier is
...
- [`../data/data-dictionary.md`](../data/data-dictionary.md) — `config/tiers` thresholds and the
  `pointHistory` field schema.
- [`../api/contracts.md`](../api/contracts.md) — the `verify-score` response shape and
  `ScoringPayload`.
