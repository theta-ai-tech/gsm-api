...
Add `broadcasts/{broadcastId}` and `offers/{offerId}` collection schemas to `docs/data/data-dictionary.md` and `docs/data/data-dictionary.md`.

**Files**:
- `docs/data/data-dictionary.md` — Add broadcasts + offers collection field tables, enums, examples
- `docs/data/data-dictionary.md` — Add broadcasts + offers collection entries
...
**Files**:
- `docs/data/data-dictionary.md` — Add playTab fields to users collection
- `docs/data/data-dictionary.md` — Add playTab to users collection sketch
...
**Files**:
- `docs/data/models.md` — Add new enums section
- `docs/data/data-dictionary.md` — Add enum definitions to Enums section

---

### E4: Documentation — Updated state machine diagram
Replace the existing state machine in `docs/api/play-tab-state-machine.md` with a refined version that accounts for BROADCAST_ACTIVE coexisting with queued offers.

**Files**:
- `docs/api/play-tab-state-machine.md` — Updated mermaid diagram with offer queue nuances + notes
...
**Files**:
- `docs/api/play-tab-state-machine.md` — Expand with envelope definition, payload per mode, examples
- `docs/design/tab1-play-payloads.md` — New file with full JSON examples per mode
...
**Files**:
- `docs/api/endpoints.md` — Add all /me/* endpoint documentation
...
```json
{
  ...
  "payload": { "/* mode-specific — see docs/design/tab1-play-payloads.md */" },
